...
def livestream():
    ...
    with ui.element("main").classes("w-full h-screen"):
        with ui.element("header").classes("w-full text-balck text-xl bg-blue justify-between px-5 py-3 flex items-center inline sticky top-0"):
        ...
        with ui.element("hero").classes("w-full h-full"):
